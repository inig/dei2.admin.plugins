...
const store = new Vuex.Store({
  ...
  state: {
    ...
    shortAppName: 'Z',
    theme: 'rgba(10, 81, 15, 1)',
    theme1: 'rgba(10, 81, 15, .1)',
    theme2: 'rgba(10, 81, 15, .2)',
    theme3: 'rgba(10, 81, 15, .3)',
    theme4: 'rgba(10, 81, 15, .4)',
    theme5: 'rgba(10, 81, 15, .5)',
    theme6: 'rgba(10, 81, 15, .6)',
    theme7: 'rgba(10, 81, 15, .7)',
    theme8: 'rgba(10, 81, 15, .8)',
    theme9: 'rgba(10, 81, 15, .9)',
    spanLeft: 5,
    spanRight: 19,
    maxSpanLeft: 5,
    maxSpanRight: 23,

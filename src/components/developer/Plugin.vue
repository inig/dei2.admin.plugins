  ...
  <div class="plugin_container">
    <div class="plugin_container_header">
      <div class="plugin_operation_container">
        <a :href="'https://static.dei2.com/plugins/' + currentPlugin + '/' + currentFileName"
           class="operation_item">
          <Tooltip content="下载文件"
                   placement="bottom"
                   :transfer="true">
            <Icon type="arrow-down-a"
                  class="operation_item_icon"
                  :class="['operation_item_icon_enable_' + enableDownload]"
                  size="18"></Icon>
          </Tooltip>
        </a>
        <div class="operation_item"
          ...
          <Tooltip content="保存文件"
            ...
            <Icon type="arrow-up-a"
                  class="operation_item_icon"
                  :class="['operation_item_icon_enable_' + enableSave]"
                  size="18"></Icon>
          </Tooltip>
        </div>
        <div class="operation_item"
             ...
             v-if="showMarkDown">
          <Tooltip :content="previewMarkDownFile ? '关闭预览' : '预览文件'"
                   placement="bottom"
                   :transfer="true">
            <Icon :type="previewMarkDownFile ? 'eye-disabled' : 'eye'"
                  class="operation_item_icon"
                  :class="['operation_item_icon_enable_' + enableSave]"
                  size="18"></Icon>
          </Tooltip>
    ...
    <div class="plugin_content_container"
      ...
      <transition name="preview-transition"
        ...
        <div class="markdown_preview_full markdown-body"
             v-if="previewMarkDownFile"
             v-html="markdownContent"></div>
      </transition>
    </div>
  </div>

<template>
  <div class="upload-plugin-container" :style="{height: height + 'px' || '300px', width: width + 'px' || '100%'}">
    <Upload
        multiple
        type="drag"
        :action="'https://talkapi.dei2.com/Zpm/common/uploadImage?phonenum=' + loginInfo.phonenum + '&token=' + loginInfo.token + '&ms=' + formData.maxSize + '&accept=' + formData.format.join(';') + '&rn=true'"

  ...
  <div class="activity_card_container">
    <div class="activity_card_inner">
      <div class="activity_preview_image_container">
        <img class="activity_preview_image"
             :src="dataValue.thumbnail || assets.defaultActivity127x200">
        ...
        <div class="activity_operation_container">
          <div class="activity_operations">
            ...
            <div class="activity_operation_item"
                 @click="edit"
                 v-if="dataValue.author === loginInfo.phonenum">
              <Tooltip content="编辑"
                       placement="right">
                <Icon type="edit"
                      size="20"></Icon>
            ...
            <div class="activity_operation_item RED"
                 @click="showRemoveActivityConfirm"
                 v-if="dataValue.author === loginInfo.phonenum">
              <Tooltip content="删除"
                       placement="right">
                <Icon type="trash-a"
              ...
              <Modal v-model="removeActivityConfirm"
                     width="360">
                <p slot="header"
...
.activity_operations {
  ...
  align-items: center;
  justify-content: center;
  background-color: rgba(73, 80, 96, 0.6);
}
  ...
  methods: {
    showPopup () {
      this.$store.commit(types.SHOW_FULL_SCREEN_POPUP, {
        ...
        subComType: 'preview',
        previewQRCode: 'http://10.2.5.0:8080/activity/preview?q=' + this.dataValue.uuid,

  ...
  <div class="app_header">
    <Row type="flex">
      ...
      <router-link :to="{path: '/'}">
        ...
        <Tooltip class="layout-logo-left"
                 :content="fullAppName"
                 placement="right">
      ...
      <div class="layout-header">
        <transition name="offline-transition"
                    enter-active-class="animated fadeIn faster"
                    leave-active-class="animated fadeOut faster">
          <div class="offline_tips"
               v-if="!online">网络连接已断开</div>
        </transition>
        ...
        <full-screen v-model="isFullScreen"
                     ...
                     class="full_screen_icon"></full-screen>
        <div class="layout-header-icon-container">
          <div @click="navToMessage"
               class="message-icon">
